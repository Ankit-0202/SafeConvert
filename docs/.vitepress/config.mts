...
export default defineConfig({
    title: "SafeConvert Docs",
    description: "Documentation for SafeConvert - The free, open-source, privacy-first PDF toolkit",
    base: '/docs/',
