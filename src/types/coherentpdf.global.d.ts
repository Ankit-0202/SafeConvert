/*
 * coherentpdf.global.d.ts — TypeScript type definitions for SafeConvert / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the SafeConvert project.
