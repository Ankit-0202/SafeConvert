import type { PDFDocument as PDFLibDocument, PDFRef } from "pdf-lib";
import type { PDFDocumentProxy, PageViewport } from "pdfjs-dist";

// Core bookmark types
export type BookmarkColor = "red" | "blue" | "green" | "yellow" | "purple" | null;
...
export type DestinationCallback = (page: number, pdfX: number, pdfY: number) => void;
