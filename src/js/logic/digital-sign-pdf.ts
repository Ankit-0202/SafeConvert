...
import type { CertificateData, SignPdfOptions } from "@/types";
...
export function parsePemFiles(
  ...
  const p12Asn1 = forge.pkcs12.toPkcs12Asn1(privateKey, [certificate], p12Password, {
    algorithm: "3des",
  });
 ...
 * but should NOT be considered secure against determined attackers. SafeConvert
