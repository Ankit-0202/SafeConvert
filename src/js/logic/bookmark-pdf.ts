...
import { COLOR_CLASSES, TEXT_COLOR_CLASSES, HEX_COLOR_MAP, PDF_COLOR_MAP } from "@/types";
...
const modalContainer = document.getElementById("modal-container") as HTMLElement | null;
...
const loaderModal = document.getElementById("loader-modal") as HTMLElement | null;
...
const closeBtn = document.getElementById("back-btn") as HTMLButtonElement | null;
...
const gotoPageInput = document.getElementById("goto-page") as HTMLInputElement | null;
...
const zoomFitBtn = document.getElementById("zoom-fit-btn") as HTMLButtonElement | null;
const zoomIndicator = document.getElementById("zoom-indicator") as HTMLElement | null;
const addTopLevelBtn = document.getElementById("add-top-level-btn") as HTMLButtonElement | null;
const titleInput = document.getElementById("bookmark-title") as HTMLInputElement | null;
const treeList = document.getElementById("bookmark-tree-list") as HTMLElement | null;
const noBookmarksEl = document.getElementById("no-bookmarks") as HTMLElement | null;
...
const searchInput = document.getElementById("search-bookmarks") as HTMLInputElement | null;
...
const importDropdown = document.getElementById("import-dropdown") as HTMLElement | null;
const exportDropdown = document.getElementById("export-dropdown") as HTMLElement | null;
const importCsvBtn = document.getElementById("import-csv-btn") as HTMLButtonElement | null;
...
const csvImportHidden = document.getElementById("csv-import-hidden") as HTMLInputElement | null;
const jsonImportHidden = document.getElementById("json-import-hidden") as HTMLInputElement | null;
const extractExistingBtn = document.getElementById(
  "extract-existing-btn",
) as HTMLButtonElement | null;
const currentPageDisplay = document.getElementById("current-page-display") as HTMLElement | null;
const filenameDisplay = document.getElementById("filename-display") as HTMLElement | null;

const batchModeCheckbox = document.getElementById("batch-mode-checkbox") as HTMLInputElement | null;
const batchOperations = document.getElementById("batch-operations") as HTMLElement | null;
const selectedCountDisplay = document.getElementById("selected-count") as HTMLElement | null;
const batchColorSelect = document.getElementById("batch-color-select") as HTMLSelectElement | null;
const batchStyleSelect = document.getElementById("batch-style-select") as HTMLSelectElement | null;
const batchDeleteBtn = document.getElementById("batch-delete-btn") as HTMLButtonElement | null;
...
const expandAllBtn = document.getElementById("expand-all-btn") as HTMLButtonElement | null;
const collapseAllBtn = document.getElementById("collapse-all-btn") as HTMLButtonElement | null;

const showViewerBtn = document.getElementById("show-viewer-btn") as HTMLButtonElement | null;
const showBookmarksBtn = document.getElementById("show-bookmarks-btn") as HTMLButtonElement | null;
const viewerSection = document.getElementById("viewer-section") as HTMLElement | null;
