# 🌍 Translation Guide for SafeConvert

This guide will help you add new languages or improve existing translations for SafeConvert.
...
SafeConvert uses **i18next** for internationalization (i18n). Currently supported languages:
...
SafeConvert uses a **static pre-rendering** approach for SEO-optimized i18n:
...
SafeConvert is **friendly, clear, and professional**. Match this tone in your translations.
...
```json
{
  "faq.analytics.answer": "We care about your privacy. SafeConvert does not track personal information. We use <a href=\"https://simpleanalytics.com\" class=\"text-indigo-400 hover:underline\" target=\"_blank\" rel=\"noopener noreferrer\">Simple Analytics</a> solely to see anonymous visit counts."
}
```
...
```json
{
  "faq.analytics.answer": "Wir schätzen Ihre Privatsphäre. SafeConvert verfolgt keine persönlichen Informationen. Wir verwenden <a href=\"https://simpleanalytics.com\" class=\"text-indigo-400 hover:underline\" target=\"_blank\" rel=\"noopener noreferrer\">Simple Analytics</a> ausschließlich, um anonyme Besucherzahlen zu sehen."
}
```
...
2. Open an issue on [GitHub](https://github.com/alam00000/safeconvert/issues)
...
Thank you for contributing to SafeConvert! 🎉
