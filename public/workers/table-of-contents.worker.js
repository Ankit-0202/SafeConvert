...
function generateTableOfContentsInWorker(pdfData, title, fontSize, fontFamily, addBookmark) {
  try {
...
self.onmessage = async function (e) {
  ...
  if (!cpdfUrl) {
    self.postMessage({
      status: "error",
      message: "CoherentPDF URL not provided. Please configure it in WASM Settings.",
    });
    return;
  }
